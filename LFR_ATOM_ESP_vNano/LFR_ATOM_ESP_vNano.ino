...
//            s0  s1  s2  s3
CD74HC4067 mux(6, 12, 7, 8);

NewPing sonar_f(2, 2, 50);
NewPing sonar_l(4, 4, 36);
NewPing sonar_r(14, 14, 36);
...
uint16_t thresh[] = {512, 512, 512, 512, 512, 512, 512, 512};
